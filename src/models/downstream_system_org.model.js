...
class DownstreamSystemOrg extends Model {

  static get tableName() {
    return 'downstream_system_org';
  }
  ...
  static get relationMappings() {
    ...
    return {
      system: {
        ...
        modelClass: System,
        join: {
          from: 'downstream_system_org.system_id',
          to: 'system.system_id',
        },
      },
      system_organization: {
        ...
        join: {
          from: 'downstream_system_org.system_organization_id',
